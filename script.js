window.addEventListener("load", function () {
    ...
    class Player {
        ...
        draw(context) {
            ...
            if (this.game.debug) {
                context.beginPath(); context.arc( this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 2 );
                context.save();
        ...
        class Larva {
            ...
            update() {
                ...
                if (this.collisionY < this.game.topMargin) {
                    ...
                    this.game.score++;
                    for (let i = 0; i < 4; i++)
                    this.game.particles.push(new Firefly(this.game, this.collisionX, this.collisionY, 'pink'))
